...
describe Admin::LinksController do
  ...
  # Admin::Link. As you add validations to Admin::Link, be sure to
  ...
  # Admin::LinksController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all admin_links as @admin_links" do
      link = Admin::Link.create! valid_attributes
      get :index, {}, valid_session
      assigns(:admin_links).should eq([link])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new link as @link" do
      ...
      assigns(:link).should be_a_new(Admin::Link)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Admin::Link" do
        expect {
          post :create, {:link => valid_attributes}, valid_session
        }.to change(Admin::Link, :count).by(1)
      end

      it "assigns a newly created link as @link" do
        post :create, {:link => valid_attributes}, valid_session
        assigns(:link).should be_a(Admin::Link)
        assigns(:link).should be_persisted
      end

      it "redirects to the created link" do
        post :create, {:link => valid_attributes}, valid_session
        response.should redirect_to(Admin::Link.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved link as @link" do
        ...
        Admin::Link.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested link" do
        link = Admin::Link.create! valid_attributes
        # Assuming there are no other admin_links in the database, this
        # specifies that the Admin::Link created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Admin::Link.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
