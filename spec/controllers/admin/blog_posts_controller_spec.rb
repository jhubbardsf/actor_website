...
describe Admin::BlogPostsController do
  ...
  # Admin::BlogPost. As you add validations to Admin::BlogPost, be sure to
  ...
  # Admin::BlogPostsController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all admin_blog_posts as @admin_blog_posts" do
      blog_post = Admin::BlogPost.create! valid_attributes
      get :index, {}, valid_session
      assigns(:admin_blog_posts).should eq([blog_post])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new blog_post as @blog_post" do
      ...
      assigns(:blog_post).should be_a_new(Admin::BlogPost)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved blog_post as @blog_post" do
        ...
        Admin::BlogPost.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested blog_post" do
        blog_post = Admin::BlogPost.create! valid_attributes
        # Assuming there are no other admin_blog_posts in the database, this
        # specifies that the Admin::BlogPost created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Admin::BlogPost.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the admin_blog_posts list" do
      blog_post = Admin::BlogPost.create! valid_attributes
      delete :destroy, {:id => blog_post.to_param}, valid_session
      response.should redirect_to(admin_blog_posts_url)
    end
  end
