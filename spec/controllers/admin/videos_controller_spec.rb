...
describe Admin::VideosController do
  ...
  describe "GET index" do
    it "assigns all admin_videos as @admin_videos" do
      ...
      assigns(:admin_videos).should eq([video])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new video as @video" do
      ...
      assigns(:video).should be_a_new(Admin::Video)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created video as @video" do
        post :create, {:video => valid_attributes}, valid_session
        assigns(:video).should be_a(Admin::Video)
        assigns(:video).should be_persisted
      end

      it "redirects to the created video" do
        post :create, {:video => valid_attributes}, valid_session
        response.should redirect_to(Admin::Video.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved video as @video" do
        ...
        Admin::Video.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested video" do
        video = Admin::Video.create! valid_attributes
        # Assuming there are no other admin_videos in the database, this
        # specifies that the Admin::Video created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Admin::Video.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
