...
describe Admin::PhotosController do
  ...
  describe "GET index" do
    it "assigns all admin_photos as @admin_photos" do
      ...
      assigns(:admin_photos).should eq([photo])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new photo as @photo" do
      ...
      assigns(:photo).should be_a_new(Admin::Photo)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created photo as @photo" do
        post :create, {:photo => valid_attributes}, valid_session
        assigns(:photo).should be_a(Admin::Photo)
        assigns(:photo).should be_persisted
      end

      it "redirects to the created photo" do
        post :create, {:photo => valid_attributes}, valid_session
        response.should redirect_to(Admin::Photo.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved photo as @photo" do
        ...
        Admin::Photo.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested photo" do
        photo = Admin::Photo.create! valid_attributes
        # Assuming there are no other admin_photos in the database, this
        # specifies that the Admin::Photo created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Admin::Photo.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the admin_photos list" do
      photo = Admin::Photo.create! valid_attributes
      delete :destroy, {:id => photo.to_param}, valid_session
      response.should redirect_to(admin_photos_url)
    end
  end
